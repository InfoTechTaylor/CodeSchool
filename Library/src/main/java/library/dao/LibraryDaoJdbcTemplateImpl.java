...
import library.dto.Author;
import library.dto.Book;
import library.dto.Publisher;
...
public class LibraryDaoJdbcTemplateImpl implements LibraryDao{
    ...
    public Book getBookById(int id) {
        try {
            ...
            Book book = jdbcTemplate.queryForObject(SQL_SELECT_BOOK,
                    new BookMapper(),
                    id);
            // get the Authors for this book adn set list on the book
    ...
    private void insertBooksAuthors(Book book) {
        ...
        // update teh books_authors bridge table with an entry for
