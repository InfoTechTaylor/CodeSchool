    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <table id="sightingTable" class="table table-hover">
                ...
                <c:forEach var="sighting" items="${viewModel.sightings}">
                    <tr>
                        <td>
                            <p>
                                <a href="/sighting/show?id=${sighting.id}"><c:out value="${sighting.date} " /></a>
                            </p>
                        </td>
                        <td>
                            <p>
                                <a href="/location/show?id=${sighting.locationId}"><c:out value="${sighting.locationName} " /></a>
                            </p>
                        </td>
                        <td>
                            <a href="/sighting/edit?id=${sighting.id}">
                                Edit
                            </a>
                        </td>
                        <td>
        ...
        <div class="col-md-6">
            ...
            <sf:form class="form-horizontal" role="form" method="POST" action="/sighting/create" modelAttribute="commandModel" novalidate="novalidate">
