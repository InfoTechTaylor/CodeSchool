...
public class PositionServiceImplTest {
    ...
    public void update() {
        ...
        // assert
        Position position = positionService.read(readPosition.getId());
    ...
    public void delete() {
        ...
        // assert
        assertNull(positionService.read(createdPosition.getId()));
    }
    ...
    public void getPositionsByPlayer(){
        ...
        List<Position> playerPositions = positionService.getPositionsByPlayer(player, Integer.MAX_VALUE, 0);
